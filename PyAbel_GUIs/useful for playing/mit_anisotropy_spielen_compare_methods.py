...
folder = ('data')
image = ('gerber_peaks_test_eq_high_intensity_anni=-1,2@40,50.dat')
...
speeds = abel.tools.vmi.angular_integration_3D(IM)

r, integrated = radial_integrate(invrs)

error = np.abs(IM - invrs)
...
im8 = ax8.imshow(invrs_direct, origin='lower', vmin=0)
...
im9 = ax9.imshow(invrs_hansenlaw, origin='lower', vmin=0)
...
im10 = ax10.imshow(invrs_daun, origin='lower', vmin=0)
...
im12 = ax12.imshow(invrs_onion_bordas, origin='lower', vmin=0)
...
im13 = ax13.imshow(invrs_onion_peeling, origin='lower', vmin=0)
...
im14 = ax14.imshow(invrs_three_point, origin='lower', vmin=0)
...
im15 = ax15.imshow(invrs_two_point, origin='lower', vmin=0)
